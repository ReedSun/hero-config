title: git中的指令
date: 2016/9/25 16:51:40
tags: Git
---

*本文借鉴自颜海镜的博客-[我的git笔记](https://zhuanlan.zhihu.com/p/22609000)*
*如有侵权，定将删除。*
##配置
配置账号信息
```
...
git config --global user.name ReedSun
git config --global user.email sunhongzhao@foxmail.com
...
配置密钥
```
ssh0keygen -t rsa -C sunhongzhao@foxmail.com #生成密钥
...
```
##参考资料
[我的git笔记-颜海镜的博客](https://zhuanlan.zhihu.com/p/22609000)